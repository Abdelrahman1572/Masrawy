        ...
        children: [
            ...
            child: Row(
              children: [
                ...
                Container(
                    ...
                    child: Row(
                      children: [
                        Text("4.1",style: GoogleFonts.robotoSlab(fontSize: 15,fontWeight: FontWeight.bold),),
          ...
          Container(
            ...
            child: Column(
              children: [
                Center(
                  child: Image.asset('assets/images/Image Popular Product 2.png',width: 300,height: 300,),
                ),
              ],
            ),
          ),
                  ...
                  children: [
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Text('Nike Sport White - Man Pant',style: GoogleFonts.robotoSlab(fontSize: 25),),
                      ),
                    ),
                  ],
                ),
